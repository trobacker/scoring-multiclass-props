...
scenarios <- data.frame(
  ...
  scenario_label = c(
    "Scenario 1: Misspecified (α=15,3,2)",
    "Scenario 2: Narrow (α=200,300,1500)",
    "Scenario 3: Dispersed (α=0.4,0.6,3)",
    "Scenario 4: Less Misspecified (α=4,5,11)"
  ),
...
p3 <- ggplot(summary_stats,
  ...
  scale_color_manual(
    values = c(
      "Scenario 1: Misspecified (α=15,3,2)" = "#E41A1C",
      "Scenario 2: Narrow (α=200,300,1500)" = "#377EB8",
      "Scenario 3: Dispersed (α=0.4,0.6,3)" = "#4DAF4A",
      "Scenario 4: Less Misspecified (α=4,5,11)" = "#984EA3"
    ),
    name = "Scenario"
  ) +
  scale_linetype_manual(
