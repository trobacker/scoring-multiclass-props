...
# Usage: Rscript run_simulations_alpha_symmetric_additional_precomputed.R
...
cat("ADDITIONAL EXTREME SCENARIOS\n")
cat("=========================================\n\n")
...
if (in_gui) {
  ...
  cat("  Rscript src/run_simulations_alpha_symmetric_additional_precomputed.R\n\n")
