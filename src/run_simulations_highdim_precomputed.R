#!/usr/bin/env Rscript
# OPTIMIZED VERSION: Parallel execution of higher-dimensional simulations (K > 3 classes) with pre-computed term2
...
# Usage: Rscript run_simulations_highdim_precomputed.R
...
cat("=========================================\n")
cat("OPTIMIZED HIGH-DIMENSIONAL SIMULATION RUNNER\n")
...
if (in_rstudio) {
  ...
  cat("For maximum speed, run from terminal: Rscript src/run_simulations_highdim_precomputed.R\n\n")
