...
TernaryPlot(alab = "Variant A prevalence \u2192", 
            ...
            padding = 0.08)
## add colors
cols <- TernaryPointValues(Func = dd_func, alpha = alpha_wrong)
ColourTernary(cols,
              spectrum = rev(hcl.colors(10, palette = "viridis", alpha = 0.6)))
AddToTernary(graphics::points, 
             thetas_wrong,
...
-   1000 simulations where observed C (and so p) change each time form Dir(alpha).
-   Forecasts Run: True alpha = c(2,4,4)
    -   (very incorrect), wrong alpha = c(10,1,1)
    -   (less incorrect), wrong alpha = c(10,10,10)
    -   (incorrect), wrong alpha = c(20,5,5)
...
df_mn1 <- data.frame(es_correct = result_mn1$es_correct,
           es_incorrect = result_mn1$es_incorrect,
           sim = "mn1")

df_mn2 <- data.frame(es_correct = result_mn2$es_correct,
           es_incorrect = result_mn2$es_incorrect,
           sim = "mn2")

df_mn3 <- data.frame(es_correct = result_mn3$es_correct,
           es_incorrect = result_mn3$es_incorrect,
           sim = "mn3")

df_mn4 <- data.frame(es_correct = result_mn4$es_correct,
           es_incorrect = result_mn4$es_incorrect,
           sim = "mn4")

df_mn5 <- data.frame(es_correct = result_mn5$es_correct,
           es_incorrect = result_mn5$es_incorrect,
           sim = "mn5")

df_nonmn1 <- data.frame(es_correct = result_notmn1$es_correct,
           es_incorrect = result_notmn1$es_incorrect,
           sim = "non-mn1")

df_nonmn2 <- data.frame(es_correct = result_notmn2$es_correct,
           es_incorrect = result_notmn2$es_incorrect,
           sim = "non-mn2")

df_nonmn3 <- data.frame(es_correct = result_notmn3$es_correct,
           es_incorrect = result_notmn3$es_incorrect,
           sim = "non-mn3")

df_nonmn4 <- data.frame(es_correct = result_notmn4$es_correct,
           es_incorrect = result_notmn4$es_incorrect,
           sim = "non-mn4")

df_nonmn5 <- data.frame(es_correct = result_notmn5$es_correct,
           es_incorrect = result_notmn5$es_incorrect,
           sim = "non-mn5")

df_combo <- df_combo <- rbind(
                              df_nonmn1,
                              df_nonmn2,
                              df_nonmn3,
                              df_nonmn4,
...
ggplot(data = df_long, aes(x = sim, y = value, fill = es)) +
  geom_boxplot() +
  theme_bw()

# ggplot(data = df_long, aes(x = es, y = value, fill = es)) + 
#   facet_wrap(~sim) + 
#   geom_boxplot() + 
#   theme_bw()
```
...
df_mn1 <- data.frame(es_diff = result_mn1$es_correct - result_mn1$es_incorrect,
           sim = "mn1")

df_mn2 <- data.frame(es_diff = result_mn2$es_correct - result_mn2$es_incorrect,
           sim = "mn2")

df_mn3 <- data.frame(es_diff = result_mn3$es_correct - result_mn3$es_incorrect,
           sim = "mn3")

df_mn4 <- data.frame(es_diff = result_mn4$es_correct - result_mn4$es_incorrect,
           sim = "mn4")

df_mn5 <- data.frame(es_diff = result_mn5$es_correct - result_mn5$es_incorrect,
           sim = "mn5")

df_nonmn1 <- data.frame(es_diff = result_notmn1$es_correct - result_notmn1$es_incorrect,
           sim = "non-mn1")

df_nonmn2 <- data.frame(es_diff = result_notmn2$es_correct - result_notmn2$es_incorrect,
           sim = "non-mn2")

df_nonmn3 <- data.frame(es_diff = result_notmn3$es_correct - result_notmn3$es_incorrect,
           sim = "non-mn3")

df_nonmn4 <- data.frame(es_diff = result_notmn4$es_correct - result_notmn4$es_incorrect,
           sim = "non-mn4")

df_nonmn5 <- data.frame(es_diff = result_notmn5$es_correct - result_notmn5$es_incorrect,
           sim = "non-mn5")
...
ggplot(data = df_combo, aes(x = sim, y = es_diff)) +
  geom_boxplot() +
  theme_bw()
```
